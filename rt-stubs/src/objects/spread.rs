...
pub unsafe extern "C-unwind" fn __bs_object_spread(target_tagged: u64, source_tagged: u64) -> u64 {
    ...
    if target_tag != 0xFFF6_0000_0000_0000 && target_tag != 0x7FF6_0000_0000_0000 && target_tag != 0xFFFE_0000_0000_0000 {
    ...
    if source_tag == 0xFFF6_0000_0000_0000 || source_tag == 0x7FF6_0000_0000_0000 || source_tag == 0xFFFE_0000_0000_0000 {
