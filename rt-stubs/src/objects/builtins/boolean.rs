...
#[no_mangle]
pub unsafe extern "C-unwind" fn __bs_Boolean_new(val: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C-unwind" fn __bs_Boolean_new_0() -> u64 {
    let obj = __bs_alloc(&BOOLEAN_VTABLE, 16);
...
#[no_mangle]
pub unsafe extern "C-unwind" fn __bs_Boolean_new_1(val: u64) -> u64 {
