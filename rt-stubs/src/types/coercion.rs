...
pub unsafe extern "C-unwind" fn __bs_Boolean(val: u64) -> u64 {
    ...
    } else if tag == 0xFFF6_0000_0000_0000 || tag == 0xFFFB_0000_0000_0000 || tag == 0xFFF9_0000_0000_0000 || tag == 0xFFFA_0000_0000_0000 || (tag == 0x7FF6_0000_0000_0000 || tag == 0xFFFE_0000_0000_0000) || tag == 0xFFFD_0000_0000_0000 {
        true
    } else {
        let f = f64::from_bits(val);
        f != 0.0 && !f.is_nan()
