...
#[no_mangle]
pub unsafe extern "C-unwind" fn __bs_Symbol(desc: u64) -> u64 {
...
/// No-arg Symbol() call
#[no_mangle]
pub unsafe extern "C-unwind" fn __bs_Symbol_0() -> u64 {
    __bs_Symbol(0xFFF1_0000_0000_0000) // undefined
}

/// 1-arg Symbol(desc) call
#[no_mangle]
pub unsafe extern "C-unwind" fn __bs_Symbol_1(desc: u64) -> u64 {
    __bs_Symbol(desc)
}

/// Returns a global object with well-known symbol properties.
#[no_mangle]
pub unsafe extern "C-unwind" fn __bs_get_Symbol_global() -> u64 {
