...
#[no_mangle]
pub unsafe extern "C-unwind" fn __bs_fs_read_file_sync(path_tagged: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C-unwind" fn __bs_fs_write_file_sync(path_tagged: u64, data_tagged: u64) {
    let path_str = get_c_string_from_tagged(path_tagged);
...
#[no_mangle]
pub unsafe extern "C-unwind" fn __bs_fs_exists_sync(path_tagged: u64) -> u64 {
    let path_str = get_c_string_from_tagged(path_tagged);
