; ModuleID = 'tests/examples/t17_daily_use_cases.ts'
source_filename = "tests/examples/t17_daily_use_cases.ts"
...
@__bs_class_BankAccount_vtable = constant { ptr, ptr, i64, i64, ptr, ptr, ptr, ptr, ptr } { ptr null, ptr @.str.9, i64 1, i64 2, ptr @__bs_class_BankAccount_field_names, ptr @__bs_class_BankAccount___get_balance, ptr @__bs_class_BankAccount___get_owner, ptr @__bs_class_BankAccount_deposit, ptr @__bs_class_BankAccount_withdraw }
@__bs_class_CaptureCell_vtable = constant { ptr, ptr, i64, i64, ptr, ptr, ptr, ptr, ptr } { ptr null, ptr @.str.12, i64 2, i64 1, ptr @__bs_class_CaptureCell_field_names, ptr null, ptr null, ptr null, ptr null }
@.str.9 = unnamed_addr constant [12 x i8] c"BankAccount\00"
@.str.10 = unnamed_addr constant [18 x i8] c"__private_balance\00"
@.str.11 = unnamed_addr constant [20 x i8] c"__private_ownerName\00"
@__bs_class_BankAccount_field_names = constant [2 x ptr] [ptr @.str.10, ptr @.str.11]
@.str.12 = unnamed_addr constant [12 x i8] c"CaptureCell\00"
@.str.13 = unnamed_addr constant [6 x i8] c"value\00"
@__bs_class_CaptureCell_field_names = constant [1 x ptr] [ptr @.str.13]
@.str.14 = unnamed_addr constant [9 x i8] c"Assert [\00"
@.str.15 = unnamed_addr constant [13 x i8] c"]: expected \00"
@.str.16 = unnamed_addr constant [7 x i8] c", got \00"
@.str.17 = unnamed_addr constant [6 x i8] c" \E2\86\92 \00"
@.str.18 = unnamed_addr constant [5 x i8] c"PASS\00"
@.str.19 = unnamed_addr constant [5 x i8] c"FAIL\00"
@.str.20 = unnamed_addr constant [19 x i8] c"Assertion failed: \00"
...
@.str.21 = unnamed_addr constant [3 x i8] c"p1\00"
@prop_str.6 = private unnamed_addr constant [5 x i8] c"name\00", align 1
@.str.22 = unnamed_addr constant [15 x i8] c"Wireless Mouse\00"
...
@.str.23 = unnamed_addr constant [3 x i8] c"p2\00"
@prop_str.11 = private unnamed_addr constant [5 x i8] c"name\00", align 1
@.str.24 = unnamed_addr constant [12 x i8] c"USB-C Cable\00"
...
@.str.25 = unnamed_addr constant [3 x i8] c"p3\00"
@prop_str.16 = private unnamed_addr constant [5 x i8] c"name\00", align 1
@.str.26 = unnamed_addr constant [20 x i8] c"Mechanical Keyboard\00"
...
@.str.27 = unnamed_addr constant [3 x i8] c"p4\00"
@prop_str.21 = private unnamed_addr constant [5 x i8] c"name\00", align 1
@.str.28 = unnamed_addr constant [11 x i8] c"4K Monitor\00"
...
@.str.29 = unnamed_addr constant [35 x i8] c"E-commerce grand total computation\00"
@.str.30 = unnamed_addr constant [38 x i8] c"Cart contains expensive items (> 250)\00"
@.str.31 = unnamed_addr constant [28 x i8] c"All cart items are in stock\00"
...
@.str.32 = unnamed_addr constant [15 x i8] c"system-default\00"
...
@.str.33 = unnamed_addr constant [13 x i8] c"Unknown City\00"
@prop_str.30 = private unnamed_addr constant [9 x i8] c"username\00", align 1
@.str.34 = unnamed_addr constant [9 x i8] c"coder123\00"
@prop_str.31 = private unnamed_addr constant [6 x i8] c"email\00", align 1
@.str.35 = unnamed_addr constant [21 x i8] c"coder123@example.com\00"
@prop_str.32 = private unnamed_addr constant [5 x i8] c"city\00", align 1
@.str.36 = unnamed_addr constant [14 x i8] c"San Francisco\00"
...
@.str.37 = unnamed_addr constant [10 x i8] c"dark-mode\00"
...
@.str.38 = unnamed_addr constant [11 x i8] c"guest_user\00"
@.str.39 = unnamed_addr constant [23 x i8] c"User1 theme preference\00"
@.str.40 = unnamed_addr constant [19 x i8] c"User1 city address\00"
@.str.41 = unnamed_addr constant [21 x i8] c"User2 theme fallback\00"
@.str.42 = unnamed_addr constant [20 x i8] c"User2 city fallback\00"
...
@.str.43 = unnamed_addr constant [30 x i8] c"Destructured renamed variable\00"
@.str.44 = unnamed_addr constant [30 x i8] c"Destructured default fontSize\00"
...
@.str.45 = unnamed_addr constant [2 x i8] c"$\00"
@.str.46 = unnamed_addr constant [15 x i8] c"Premium Coffee\00"
@.str.47 = unnamed_addr constant [10 x i8] c"Receipt: \00"
@.str.48 = unnamed_addr constant [3 x i8] c"x \00"
@.str.49 = unnamed_addr constant [5 x i8] c" at \00"
@.str.50 = unnamed_addr constant [6 x i8] c" each\00"
@.str.51 = unnamed_addr constant [41 x i8] c"Receipt: 3x Premium Coffee at $5.99 each\00"
@.str.52 = unnamed_addr constant [32 x i8] c"Invoice currency formatting tag\00"
@.str.53 = unnamed_addr constant [12 x i8] c"Alice Smith\00"
@.str.54 = unnamed_addr constant [19 x i8] c"Account owner name\00"
@.str.55 = unnamed_addr constant [24 x i8] c"Initial account balance\00"
@.str.56 = unnamed_addr constant [29 x i8] c"Deposit operation successful\00"
@.str.57 = unnamed_addr constant [22 x i8] c"Balance after deposit\00"
@.str.58 = unnamed_addr constant [32 x i8] c"Withdrawal operation successful\00"
@.str.59 = unnamed_addr constant [25 x i8] c"Balance after withdrawal\00"
@.str.60 = unnamed_addr constant [29 x i8] c"Overdraft correctly rejected\00"
@.str.61 = unnamed_addr constant [47 x i8] c"Balance remains unaffected by failed overdraft\00"
@.str.62 = unnamed_addr constant [43 x i8] c"=== RUNNING DAILY USE CASES TEST SUITE ===\00"
@.str.63 = unnamed_addr constant [48 x i8] c"=== ALL DAILY USE CASES PASSED SUCCESSFULLY ===\00"
@__bs_class_val_BankAccount = global i64 -4222124650659840
...
bb0:
  ...
  %box_str = or i64 ptrtoint (ptr @.str.14 to i64), -2533274790395904
  ...
  %box_str13 = or i64 ptrtoint (ptr @.str.15 to i64), -2533274790395904
  ...
  %box_str19 = or i64 ptrtoint (ptr @.str.16 to i64), -2533274790395904
  ...
  %box_str25 = or i64 ptrtoint (ptr @.str.17 to i64), -2533274790395904
...
bb1:                                              ; preds = %bb0
  %box_str28 = or i64 ptrtoint (ptr @.str.18 to i64), -2533274790395904
  store i64 %box_str28, ptr %r12, align 4
  br label %bb3

bb2:                                              ; preds = %bb0
  %box_str29 = or i64 ptrtoint (ptr @.str.19 to i64), -2533274790395904
...
bb4:                                              ; preds = %bb3
  %box_str48 = or i64 ptrtoint (ptr @.str.20 to i64), -2533274790395904
...
bb0:
  ...
  %box_str5 = or i64 ptrtoint (ptr @.str.22 to i64), -2533274790395904
  ...
  %box_str19 = or i64 ptrtoint (ptr @.str.23 to i64), -2533274790395904
  %prop_set20 = call i64 @__bs_prop_set(i64 %r718, ptr @prop_str.10, i32 2, i64 %box_str19)
  %r721 = load i64, ptr %r7, align 4
  %box_str22 = or i64 ptrtoint (ptr @.str.24 to i64), -2533274790395904
  ...
  %box_str36 = or i64 ptrtoint (ptr @.str.25 to i64), -2533274790395904
  %prop_set37 = call i64 @__bs_prop_set(i64 %r1035, ptr @prop_str.15, i32 2, i64 %box_str36)
  %r1038 = load i64, ptr %r10, align 4
  %box_str39 = or i64 ptrtoint (ptr @.str.26 to i64), -2533274790395904
  ...
  %box_str53 = or i64 ptrtoint (ptr @.str.27 to i64), -2533274790395904
  %prop_set54 = call i64 @__bs_prop_set(i64 %r1352, ptr @prop_str.20, i32 2, i64 %box_str53)
  %r1355 = load i64, ptr %r13, align 4
  %box_str56 = or i64 ptrtoint (ptr @.str.28 to i64), -2533274790395904
  ...
  %box_str72 = or i64 ptrtoint (ptr @.str.29 to i64), -2533274790395904
  ...
  %box_str88 = or i64 ptrtoint (ptr @.str.30 to i64), -2533274790395904
  ...
  %box_str91 = or i64 ptrtoint (ptr @.str.31 to i64), -2533274790395904
...
bb11:                                             ; preds = %bb5
  %box_str = or i64 ptrtoint (ptr @.str.33 to i64), -2533274790395904
...
bb0:
  ...
  %r311 = load i64, ptr %r3, align 4
  %box_str = or i64 ptrtoint (ptr @.str.34 to i64), -2533274790395904
  ...
  %r514 = load i64, ptr %r5, align 4
  %box_str15 = or i64 ptrtoint (ptr @.str.35 to i64), -2533274790395904
  ...
  %box_str20 = or i64 ptrtoint (ptr @.str.36 to i64), -2533274790395904
  ...
  %box_str31 = or i64 ptrtoint (ptr @.str.37 to i64), -2533274790395904
  ...
  %box_str40 = or i64 ptrtoint (ptr @.str.38 to i64), -2533274790395904
  ...
  %box_str46 = or i64 ptrtoint (ptr @.str.37 to i64), -2533274790395904
  %box_str47 = or i64 ptrtoint (ptr @.str.39 to i64), -2533274790395904
  ...
  %box_str52 = or i64 ptrtoint (ptr @.str.36 to i64), -2533274790395904
  %box_str53 = or i64 ptrtoint (ptr @.str.40 to i64), -2533274790395904
  ...
  %box_str58 = or i64 ptrtoint (ptr @.str.32 to i64), -2533274790395904
  %box_str59 = or i64 ptrtoint (ptr @.str.41 to i64), -2533274790395904
  ...
  %box_str64 = or i64 ptrtoint (ptr @.str.33 to i64), -2533274790395904
  %box_str65 = or i64 ptrtoint (ptr @.str.42 to i64), -2533274790395904
...
bb6:                                              ; preds = %bb9, %bb4
  ...
  %box_str104 = or i64 ptrtoint (ptr @.str.34 to i64), -2533274790395904
  %box_str105 = or i64 ptrtoint (ptr @.str.43 to i64), -2533274790395904
  ...
  %box_str108 = or i64 ptrtoint (ptr @.str.44 to i64), -2533274790395904
...
bb5:                                              ; preds = %bb2
  %box_str = or i64 ptrtoint (ptr @.str.45 to i64), -2533274790395904
...
bb0:
  ...
  %box_str = or i64 ptrtoint (ptr @.str.46 to i64), -2533274790395904
  ...
  %box_str31 = or i64 ptrtoint (ptr @.str.51 to i64), -2533274790395904
  %box_str32 = or i64 ptrtoint (ptr @.str.52 to i64), -2533274790395904
...
define i64 @__bs_class_BankAccount_constructor(i64 %0, i64 %1, i64 %2) {
bb0:
  %regs_array = alloca [4 x i64], align 8
  %3 = ptrtoint ptr %regs_array to i64
  %regs_ptr = inttoptr i64 %3 to ptr
  ...
  %payload = and i64 %r01, 281474976710655
  %obj_ptr = inttoptr i64 %payload to ptr
  %field_ptr = getelementptr i64, ptr %obj_ptr, i32 1
  store i64 0, ptr %field_ptr, align 4
  %r02 = load i64, ptr %r0, align 4
  %payload3 = and i64 %r02, 281474976710655
  %obj_ptr4 = inttoptr i64 %payload3 to ptr
  %field_ptr5 = getelementptr i64, ptr %obj_ptr4, i32 2
  store i64 -4222124650659840, ptr %field_ptr5, align 4
  %r06 = load i64, ptr %r0, align 4
  %payload7 = and i64 %r06, 281474976710655
  %obj_ptr8 = inttoptr i64 %payload7 to ptr
  %field_ptr9 = getelementptr i64, ptr %obj_ptr8, i32 2
  %r110 = load i64, ptr %r1, align 4
  store i64 %r110, ptr %field_ptr9, align 4
  %r211 = load i64, ptr %r2, align 4
  %unbox_num = bitcast i64 %r211 to double
  %cmp = fcmp ogt double %unbox_num, 0.000000e+00
  %box_bool = select i1 %cmp, i64 -3377699720527872, i64 -3659174697238528
  store i64 %box_bool, ptr %r3, align 4
  %r312 = load i64, ptr %r3, align 4
  %t16 = lshr i64 %r312, 48
  %is_tagged = icmp uge i64 %t16, 65521
  %tag_truthy = icmp uge i64 %t16, 65524
  %asf64 = bitcast i64 %r312 to double
  %num_truthy = fcmp one double %asf64, 0.000000e+00
  %truthy = select i1 %is_tagged, i1 %tag_truthy, i1 %num_truthy
  br i1 %truthy, label %bb1, label %bb2
...
bb1:                                              ; preds = %bb0
  ...
  %payload14 = and i64 %r013, 281474976710655
  %obj_ptr15 = inttoptr i64 %payload14 to ptr
  %field_ptr16 = getelementptr i64, ptr %obj_ptr15, i32 1
  %r217 = load i64, ptr %r2, align 4
  store i64 %r217, ptr %field_ptr16, align 4
  br label %bb3
...
define i64 @__bs_class_BankAccount___get_balance(i64 %0) {
bb0:
  %regs_array = alloca [2 x i64], align 8
  %1 = ptrtoint ptr %regs_array to i64
  %regs_ptr = inttoptr i64 %1 to ptr
  %r0 = getelementptr i64, ptr %regs_array, i32 0
  store i64 -4222124650659840, ptr %r0, align 4
  ...
  %shadow_frame = alloca { ptr, i32, i32, ptr }, align 8
  %num_roots_ptr = getelementptr inbounds nuw { ptr, i32, i32, ptr }, ptr %shadow_frame, i32 0, i32 1
  store i32 2, ptr %num_roots_ptr, align 4
  %roots_ptr = getelementptr inbounds nuw { ptr, i32, i32, ptr }, ptr %shadow_frame, i32 0, i32 3
  store ptr %regs_ptr, ptr %roots_ptr, align 8
  call void @__bs_shadow_push(ptr %shadow_frame)
  store i64 %0, ptr %r0, align 4
...
define i64 @__bs_class_BankAccount___get_owner(i64 %0) {
bb0:
  %regs_array = alloca [2 x i64], align 8
  %1 = ptrtoint ptr %regs_array to i64
  %regs_ptr = inttoptr i64 %1 to ptr
...
define i64 @__bs_class_BankAccount_deposit(i64 %0, i64 %1) {
bb0:
  %regs_array = alloca [5 x i64], align 8
  %2 = ptrtoint ptr %regs_array to i64
  %regs_ptr = inttoptr i64 %2 to ptr
  ...
  store i64 %1, ptr %r1, align 4
  %r11 = load i64, ptr %r1, align 4
  %unbox_num = bitcast i64 %r11 to double
  %cmp = fcmp ogt double %unbox_num, 0.000000e+00
  %box_bool = select i1 %cmp, i64 -3377699720527872, i64 -3659174697238528
  store i64 %box_bool, ptr %r2, align 4
  %r22 = load i64, ptr %r2, align 4
  %t16 = lshr i64 %r22, 48
  %is_tagged = icmp uge i64 %t16, 65521
  %tag_truthy = icmp uge i64 %t16, 65524
  %asf64 = bitcast i64 %r22 to double
  %num_truthy = fcmp one double %asf64, 0.000000e+00
  %truthy = select i1 %is_tagged, i1 %tag_truthy, i1 %num_truthy
  br i1 %truthy, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  %r03 = load i64, ptr %r0, align 4
  %payload = and i64 %r03, 281474976710655
  %obj_ptr = inttoptr i64 %payload to ptr
  %field_ptr = getelementptr i64, ptr %obj_ptr, i32 1
  %loaded = load i64, ptr %field_ptr, align 4
  store i64 %loaded, ptr %r3, align 4
  %r34 = load i64, ptr %r3, align 4
  %r15 = load i64, ptr %r1, align 4
  %add_call = call i64 @__bs_add(i64 %r34, i64 %r15)
  store i64 %add_call, ptr %r4, align 4
  %r06 = load i64, ptr %r0, align 4
  %payload7 = and i64 %r06, 281474976710655
  %obj_ptr8 = inttoptr i64 %payload7 to ptr
  %field_ptr9 = getelementptr i64, ptr %obj_ptr8, i32 1
  %r410 = load i64, ptr %r4, align 4
  store i64 %r410, ptr %field_ptr9, align 4
  call void @__bs_shadow_pop()
  ret i64 -3377699720527872
...
bb3:                                              ; preds = %bb2
  call void @__bs_shadow_pop()
  ret i64 -3659174697238528
}

define i64 @__bs_class_BankAccount_withdraw(i64 %0, i64 %1) {
bb0:
  ...
  %r22 = load i64, ptr %r2, align 4
  store i64 %r22, ptr %r3, align 4
  %r23 = load i64, ptr %r2, align 4
  %t16 = lshr i64 %r23, 48
  %is_tagged = icmp uge i64 %t16, 65521
  %tag_truthy = icmp uge i64 %t16, 65524
  %asf64 = bitcast i64 %r23 to double
  %num_truthy = fcmp one double %asf64, 0.000000e+00
  %truthy = select i1 %is_tagged, i1 %tag_truthy, i1 %num_truthy
  br i1 %truthy, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  %r04 = load i64, ptr %r0, align 4
  %payload = and i64 %r04, 281474976710655
  %obj_ptr = inttoptr i64 %payload to ptr
  %field_ptr = getelementptr i64, ptr %obj_ptr, i32 1
  %loaded = load i64, ptr %field_ptr, align 4
  store i64 %loaded, ptr %r4, align 4
  %r45 = load i64, ptr %r4, align 4
  %r16 = load i64, ptr %r1, align 4
  %unbox_num7 = bitcast i64 %r45 to double
  %unbox_num8 = bitcast i64 %r16 to double
  %cmp9 = fcmp oge double %unbox_num7, %unbox_num8
  %box_bool10 = select i1 %cmp9, i64 -3377699720527872, i64 -3659174697238528
  store i64 %box_bool10, ptr %r5, align 4
  %r511 = load i64, ptr %r5, align 4
  store i64 %r511, ptr %r3, align 4
  br label %bb2

bb2:                                              ; preds = %bb1, %bb0
  %r312 = load i64, ptr %r3, align 4
  %t1613 = lshr i64 %r312, 48
  %is_tagged14 = icmp uge i64 %t1613, 65521
  %tag_truthy15 = icmp uge i64 %t1613, 65524
  %asf6416 = bitcast i64 %r312 to double
  %num_truthy17 = fcmp one double %asf6416, 0.000000e+00
  %truthy18 = select i1 %is_tagged14, i1 %tag_truthy15, i1 %num_truthy17
  br i1 %truthy18, label %bb3, label %bb4

bb3:                                              ; preds = %bb2
  %r019 = load i64, ptr %r0, align 4
  %payload20 = and i64 %r019, 281474976710655
  %obj_ptr21 = inttoptr i64 %payload20 to ptr
  %field_ptr22 = getelementptr i64, ptr %obj_ptr21, i32 1
  %loaded23 = load i64, ptr %field_ptr22, align 4
  store i64 %loaded23, ptr %r6, align 4
  %r624 = load i64, ptr %r6, align 4
  %r125 = load i64, ptr %r1, align 4
  %unbox_num26 = bitcast i64 %r624 to double
  %unbox_num27 = bitcast i64 %r125 to double
  %sub = fsub double %unbox_num26, %unbox_num27
  %box_num = bitcast double %sub to i64
  store i64 %box_num, ptr %r7, align 4
  %r028 = load i64, ptr %r0, align 4
  %payload29 = and i64 %r028, 281474976710655
  %obj_ptr30 = inttoptr i64 %payload29 to ptr
  %field_ptr31 = getelementptr i64, ptr %obj_ptr30, i32 1
  %r732 = load i64, ptr %r7, align 4
  store i64 %r732, ptr %field_ptr31, align 4
  call void @__bs_shadow_pop()
  ret i64 -3377699720527872
...
define i64 @__bs_runClassTests(i64 %0) {
bb0:
  %regs_array = alloca [23 x i64], align 8
  %1 = ptrtoint ptr %regs_array to i64
  %regs_ptr = inttoptr i64 %1 to ptr
  %r0 = getelementptr i64, ptr %regs_array, i32 0
  store i64 -4222124650659840, ptr %r0, align 4
  ...
  %shadow_frame = alloca { ptr, i32, i32, ptr }, align 8
  %num_roots_ptr = getelementptr inbounds nuw { ptr, i32, i32, ptr }, ptr %shadow_frame, i32 0, i32 1
  store i32 23, ptr %num_roots_ptr, align 4
  %roots_ptr = getelementptr inbounds nuw { ptr, i32, i32, ptr }, ptr %shadow_frame, i32 0, i32 3
  store ptr %regs_ptr, ptr %roots_ptr, align 8
  call void @__bs_shadow_push(ptr %shadow_frame)
  store i64 %0, ptr %r0, align 4
  %alloc = call i64 @__bs_alloc(ptr @__bs_class_BankAccount_vtable, i64 24)
  store i64 %alloc, ptr %r2, align 4
  %r23 = load i64, ptr %r2, align 4
  %box_str = or i64 ptrtoint (ptr @.str.53 to i64), -2533274790395904
  %call = call i64 @__bs_class_BankAccount_constructor(i64 %r23, i64 %box_str, i64 4636737291354636288)
  store i64 %call, ptr %r3, align 4
  %r24 = load i64, ptr %r2, align 4
  store i64 %r24, ptr %r1, align 4
  %r110 = load i64, ptr %r1, align 4
  %payload = and i64 %r110, 281474976710655
  %obj_ptr = inttoptr i64 %payload to ptr
  %vtable_ptr = load ptr, ptr %obj_ptr, align 8
  %method_fn_ptr_ptr = getelementptr ptr, ptr %vtable_ptr, i32 6
  %method_fn_ptr = load ptr, ptr %method_fn_ptr_ptr, align 8
  %r111 = load i64, ptr %r1, align 4
  %vcall = call i64 %method_fn_ptr(i64 %r111)
  store i64 %vcall, ptr %r4, align 4
  %r412 = load i64, ptr %r4, align 4
  %box_str13 = or i64 ptrtoint (ptr @.str.53 to i64), -2533274790395904
  %box_str14 = or i64 ptrtoint (ptr @.str.54 to i64), -2533274790395904
  %call15 = call i64 @__bs_assertEqual(i64 -4222124650659840, i64 %r412, i64 %box_str13, i64 %box_str14)
  store i64 %call15, ptr %r5, align 4
  %r116 = load i64, ptr %r1, align 4
  %payload17 = and i64 %r116, 281474976710655
  %obj_ptr18 = inttoptr i64 %payload17 to ptr
  %vtable_ptr19 = load ptr, ptr %obj_ptr18, align 8
  %method_fn_ptr_ptr20 = getelementptr ptr, ptr %vtable_ptr19, i32 5
  %method_fn_ptr21 = load ptr, ptr %method_fn_ptr_ptr20, align 8
  %r122 = load i64, ptr %r1, align 4
  %vcall23 = call i64 %method_fn_ptr21(i64 %r122)
  store i64 %vcall23, ptr %r6, align 4
  %r624 = load i64, ptr %r6, align 4
  %box_str25 = or i64 ptrtoint (ptr @.str.55 to i64), -2533274790395904
  %call26 = call i64 @__bs_assertEqual(i64 -4222124650659840, i64 %r624, i64 4636737291354636288, i64 %box_str25)
  store i64 %call26, ptr %r7, align 4
  %r127 = load i64, ptr %r1, align 4
  %payload28 = and i64 %r127, 281474976710655
  %obj_ptr29 = inttoptr i64 %payload28 to ptr
  %vtable_ptr30 = load ptr, ptr %obj_ptr29, align 8
  %method_fn_ptr_ptr31 = getelementptr ptr, ptr %vtable_ptr30, i32 7
  %method_fn_ptr32 = load ptr, ptr %method_fn_ptr_ptr31, align 8
  %r133 = load i64, ptr %r1, align 4
  %vcall34 = call i64 %method_fn_ptr32(i64 %r133, i64 4632304060471443456)
  store i64 %vcall34, ptr %r9, align 4
  %r935 = load i64, ptr %r9, align 4
  store i64 %r935, ptr %r8, align 4
  %r836 = load i64, ptr %r8, align 4
  %box_str37 = or i64 ptrtoint (ptr @.str.56 to i64), -2533274790395904
  %call38 = call i64 @__bs_assertEqual(i64 -4222124650659840, i64 %r836, i64 -3377699720527872, i64 %box_str37)
  store i64 %call38, ptr %r10, align 4
  %r139 = load i64, ptr %r1, align 4
  %payload40 = and i64 %r139, 281474976710655
  %obj_ptr41 = inttoptr i64 %payload40 to ptr
  %vtable_ptr42 = load ptr, ptr %obj_ptr41, align 8
  %method_fn_ptr_ptr43 = getelementptr ptr, ptr %vtable_ptr42, i32 5
  %method_fn_ptr44 = load ptr, ptr %method_fn_ptr_ptr43, align 8
  %r145 = load i64, ptr %r1, align 4
  %vcall46 = call i64 %method_fn_ptr44(i64 %r145)
  store i64 %vcall46, ptr %r11, align 4
  %r1147 = load i64, ptr %r11, align 4
  %box_str48 = or i64 ptrtoint (ptr @.str.57 to i64), -2533274790395904
  %call49 = call i64 @__bs_assertEqual(i64 -4222124650659840, i64 %r1147, i64 4639499264563609600, i64 %box_str48)
  store i64 %call49, ptr %r12, align 4
  %r150 = load i64, ptr %r1, align 4
  %payload51 = and i64 %r150, 281474976710655
  %obj_ptr52 = inttoptr i64 %payload51 to ptr
  %vtable_ptr53 = load ptr, ptr %obj_ptr52, align 8
  %method_fn_ptr_ptr54 = getelementptr ptr, ptr %vtable_ptr53, i32 8
  %method_fn_ptr55 = load ptr, ptr %method_fn_ptr_ptr54, align 8
  %r156 = load i64, ptr %r1, align 4
  %vcall57 = call i64 %method_fn_ptr55(i64 %r156, i64 4629137466983448576)
  store i64 %vcall57, ptr %r14, align 4
  %r1458 = load i64, ptr %r14, align 4
  store i64 %r1458, ptr %r13, align 4
  %r1359 = load i64, ptr %r13, align 4
  %box_str60 = or i64 ptrtoint (ptr @.str.58 to i64), -2533274790395904
  %call61 = call i64 @__bs_assertEqual(i64 -4222124650659840, i64 %r1359, i64 -3377699720527872, i64 %box_str60)
  store i64 %call61, ptr %r15, align 4
  %r162 = load i64, ptr %r1, align 4
  %payload63 = and i64 %r162, 281474976710655
  %obj_ptr64 = inttoptr i64 %payload63 to ptr
  %vtable_ptr65 = load ptr, ptr %obj_ptr64, align 8
  %method_fn_ptr_ptr66 = getelementptr ptr, ptr %vtable_ptr65, i32 5
  %method_fn_ptr67 = load ptr, ptr %method_fn_ptr_ptr66, align 8
  %r168 = load i64, ptr %r1, align 4
  %vcall69 = call i64 %method_fn_ptr67(i64 %r168)
  store i64 %vcall69, ptr %r16, align 4
  %r1670 = load i64, ptr %r16, align 4
  %box_str71 = or i64 ptrtoint (ptr @.str.59 to i64), -2533274790395904
  %call72 = call i64 @__bs_assertEqual(i64 -4222124650659840, i64 %r1670, i64 4638179850610278400, i64 %box_str71)
  store i64 %call72, ptr %r17, align 4
  %r173 = load i64, ptr %r1, align 4
  %payload74 = and i64 %r173, 281474976710655
  %obj_ptr75 = inttoptr i64 %payload74 to ptr
  %vtable_ptr76 = load ptr, ptr %obj_ptr75, align 8
  %method_fn_ptr_ptr77 = getelementptr ptr, ptr %vtable_ptr76, i32 8
  %method_fn_ptr78 = load ptr, ptr %method_fn_ptr_ptr77, align 8
  %r179 = load i64, ptr %r1, align 4
  %vcall80 = call i64 %method_fn_ptr78(i64 %r179, i64 4641240890982006784)
  store i64 %vcall80, ptr %r19, align 4
  %r1981 = load i64, ptr %r19, align 4
  store i64 %r1981, ptr %r18, align 4
  %r1882 = load i64, ptr %r18, align 4
  %box_str83 = or i64 ptrtoint (ptr @.str.60 to i64), -2533274790395904
  %call84 = call i64 @__bs_assertEqual(i64 -4222124650659840, i64 %r1882, i64 -3659174697238528, i64 %box_str83)
  store i64 %call84, ptr %r20, align 4
  %r185 = load i64, ptr %r1, align 4
  %payload86 = and i64 %r185, 281474976710655
  %obj_ptr87 = inttoptr i64 %payload86 to ptr
  %vtable_ptr88 = load ptr, ptr %obj_ptr87, align 8
  %method_fn_ptr_ptr89 = getelementptr ptr, ptr %vtable_ptr88, i32 5
  %method_fn_ptr90 = load ptr, ptr %method_fn_ptr_ptr89, align 8
  %r191 = load i64, ptr %r1, align 4
  %vcall92 = call i64 %method_fn_ptr90(i64 %r191)
  store i64 %vcall92, ptr %r21, align 4
  %r2193 = load i64, ptr %r21, align 4
  %box_str94 = or i64 ptrtoint (ptr @.str.61 to i64), -2533274790395904
  %call95 = call i64 @__bs_assertEqual(i64 -4222124650659840, i64 %r2193, i64 4638179850610278400, i64 %box_str94)
  store i64 %call95, ptr %r22, align 4
  call void @__bs_shadow_pop()
  ret i64 -4222124650659840
}
...
bb0:
  ...
  call void @__bs_shadow_push(ptr %shadow_frame)
  store i64 %0, ptr %r0, align 4
  %box_str = or i64 ptrtoint (ptr @.str.62 to i64), -2533274790395904
  call void @__bs_console_log_1(i64 %box_str)
  store i64 -4222124650659840, ptr %r1, align 4
  %call = call i64 @__bs_runCartTests(i64 -4222124650659840)
  store i64 %call, ptr %r2, align 4
  %call1 = call i64 @__bs_runProfileTests(i64 -4222124650659840)
  store i64 %call1, ptr %r3, align 4
  %call2 = call i64 @__bs_runTemplateTests(i64 -4222124650659840)
  store i64 %call2, ptr %r4, align 4
  %call3 = call i64 @__bs_runClassTests(i64 -4222124650659840)
  store i64 %call3, ptr %r5, align 4
  %box_str4 = or i64 ptrtoint (ptr @.str.63 to i64), -2533274790395904
  call void @__bs_console_log_1(i64 %box_str4)
  store i64 -4222124650659840, ptr %r6, align 4
  call void @__bs_shadow_pop()
  ret i64 -4222124650659840
}
...
bb0:
  ...
  %alloc_closure11 = call i64 @__bs_alloc_closure(i64 16)
  %payload12 = and i64 %alloc_closure11, 281474976710655
  %closure_ptr13 = inttoptr i64 %payload12 to ptr
  %fn_slot14 = getelementptr ptr, ptr %closure_ptr13, i32 0
  store ptr @__bs_calculateCartTotal, ptr %fn_slot14, align 8
  %unused_slot15 = getelementptr i64, ptr %closure_ptr13, i32 1
  store i64 -4222124650659840, ptr %unused_slot15, align 4
  store i64 %alloc_closure11, ptr %r3, align 4
  %r316 = load i64, ptr %r3, align 4
  store i64 %r316, ptr %r2, align 4
  %alloc_closure17 = call i64 @__bs_alloc_closure(i64 16)
  %payload18 = and i64 %alloc_closure17, 281474976710655
  %closure_ptr19 = inttoptr i64 %payload18 to ptr
  %fn_slot20 = getelementptr ptr, ptr %closure_ptr19, i32 0
  store ptr @__bs_runCartTests, ptr %fn_slot20, align 8
  %unused_slot21 = getelementptr i64, ptr %closure_ptr19, i32 1
  store i64 -4222124650659840, ptr %unused_slot21, align 4
  store i64 %alloc_closure17, ptr %r5, align 4
  %r522 = load i64, ptr %r5, align 4
  store i64 %r522, ptr %r4, align 4
  %alloc_closure23 = call i64 @__bs_alloc_closure(i64 16)
  %payload24 = and i64 %alloc_closure23, 281474976710655
  %closure_ptr25 = inttoptr i64 %payload24 to ptr
  %fn_slot26 = getelementptr ptr, ptr %closure_ptr25, i32 0
  store ptr @__bs_getUserTheme, ptr %fn_slot26, align 8
  %unused_slot27 = getelementptr i64, ptr %closure_ptr25, i32 1
  store i64 -4222124650659840, ptr %unused_slot27, align 4
  store i64 %alloc_closure23, ptr %r7, align 4
  %r728 = load i64, ptr %r7, align 4
  store i64 %r728, ptr %r6, align 4
  %alloc_closure29 = call i64 @__bs_alloc_closure(i64 16)
  %payload30 = and i64 %alloc_closure29, 281474976710655
  %closure_ptr31 = inttoptr i64 %payload30 to ptr
  %fn_slot32 = getelementptr ptr, ptr %closure_ptr31, i32 0
  store ptr @__bs_getUserCity, ptr %fn_slot32, align 8
  %unused_slot33 = getelementptr i64, ptr %closure_ptr31, i32 1
  store i64 -4222124650659840, ptr %unused_slot33, align 4
  store i64 %alloc_closure29, ptr %r9, align 4
  %r934 = load i64, ptr %r9, align 4
  store i64 %r934, ptr %r8, align 4
  %alloc_closure35 = call i64 @__bs_alloc_closure(i64 16)
  %payload36 = and i64 %alloc_closure35, 281474976710655
  %closure_ptr37 = inttoptr i64 %payload36 to ptr
  %fn_slot38 = getelementptr ptr, ptr %closure_ptr37, i32 0
  store ptr @__bs_runProfileTests, ptr %fn_slot38, align 8
  %unused_slot39 = getelementptr i64, ptr %closure_ptr37, i32 1
  store i64 -4222124650659840, ptr %unused_slot39, align 4
  store i64 %alloc_closure35, ptr %r11, align 4
  %r1140 = load i64, ptr %r11, align 4
  store i64 %r1140, ptr %r10, align 4
  %alloc_closure41 = call i64 @__bs_alloc_closure(i64 16)
  %payload42 = and i64 %alloc_closure41, 281474976710655
  %closure_ptr43 = inttoptr i64 %payload42 to ptr
  %fn_slot44 = getelementptr ptr, ptr %closure_ptr43, i32 0
  store ptr @__bs_formatCurrency, ptr %fn_slot44, align 8
  %unused_slot45 = getelementptr i64, ptr %closure_ptr43, i32 1
  store i64 -4222124650659840, ptr %unused_slot45, align 4
  store i64 %alloc_closure41, ptr %r13, align 4
  %r1346 = load i64, ptr %r13, align 4
  store i64 %r1346, ptr %r12, align 4
  %alloc_closure47 = call i64 @__bs_alloc_closure(i64 24)
  %payload48 = and i64 %alloc_closure47, 281474976710655
  %closure_ptr49 = inttoptr i64 %payload48 to ptr
  %fn_slot50 = getelementptr ptr, ptr %closure_ptr49, i32 0
  store ptr @__bs_runTemplateTests, ptr %fn_slot50, align 8
  %unused_slot51 = getelementptr i64, ptr %closure_ptr49, i32 1
  store i64 -4222124650659840, ptr %unused_slot51, align 4
  %r1252 = load i64, ptr %r12, align 4
  %capture_slot = getelementptr i64, ptr %closure_ptr49, i32 2
  store i64 %r1252, ptr %capture_slot, align 4
  store i64 %alloc_closure47, ptr %r15, align 4
  %r1553 = load i64, ptr %r15, align 4
  store i64 %r1553, ptr %r14, align 4
  %call = call i64 @__bs_new_object()
  store i64 %call, ptr %r17, align 4
  %r1754 = load i64, ptr %r17, align 4
  store i64 %r1754, ptr %r16, align 4
  %r1655 = load i64, ptr %r16, align 4
  store i64 %r1655, ptr @__bs_class_val_BankAccount, align 4
  %alloc_closure56 = call i64 @__bs_alloc_closure(i64 16)
  %payload57 = and i64 %alloc_closure56, 281474976710655
  %closure_ptr58 = inttoptr i64 %payload57 to ptr
  %fn_slot59 = getelementptr ptr, ptr %closure_ptr58, i32 0
  store ptr @__bs_runClassTests, ptr %fn_slot59, align 8
  %unused_slot60 = getelementptr i64, ptr %closure_ptr58, i32 1
  store i64 -4222124650659840, ptr %unused_slot60, align 4
  store i64 %alloc_closure56, ptr %r19, align 4
  %r1961 = load i64, ptr %r19, align 4
  store i64 %r1961, ptr %r18, align 4
  %alloc_closure62 = call i64 @__bs_alloc_closure(i64 16)
  %payload63 = and i64 %alloc_closure62, 281474976710655
  %closure_ptr64 = inttoptr i64 %payload63 to ptr
  %fn_slot65 = getelementptr ptr, ptr %closure_ptr64, i32 0
  store ptr @__bs_main, ptr %fn_slot65, align 8
  %unused_slot66 = getelementptr i64, ptr %closure_ptr64, i32 1
  store i64 -4222124650659840, ptr %unused_slot66, align 4
  store i64 %alloc_closure62, ptr %r21, align 4
  %r2167 = load i64, ptr %r21, align 4
  store i64 %r2167, ptr %r20, align 4
  %call68 = call i64 @__bs_main(i64 -4222124650659840)
  store i64 %call68, ptr %r22, align 4
