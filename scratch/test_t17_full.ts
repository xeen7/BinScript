...
function runTemplateTests() {
  ...
  console.log("Finished formatting currency: " + invoice);
...
function main() {
  ...
  console.log("Calling runCartTests");
  runCartTests();
  console.log("Calling runProfileTests");
  runProfileTests();
  console.log("Calling runTemplateTests");
  runTemplateTests();
  console.log("Calling runClassTests");
  runClassTests();
